...
# MAGIC UC_TOOL_NAMES = ["workshop.supply_chain.get_shipments", "workshop.supply_chain.temp_gap", "workshop.supply_chain.get_supplier_details", "workshop.supply_chain.get_backup_inventory"]
# MAGIC
...
# MAGIC             index_name="workshop.supply_chain.supplier_sops_vs_index",
